...
public final class Constants {
  public static final class DriveConstants {
        ...
        public static final double kFrontLeftChassisAngularOffset = (2.40); //5
        public static final double kFrontRightChassisAngularOffset = (4.71); //8
        public static final double kBackLeftChassisAngularOffset = (4.74); //6
        public static final double kBackRightChassisAngularOffset = (3.34); //7
  ...
  public static final class ModuleConstants {
    ...
    public static final double kWheelDiameterMeters = Units.inchesToMeters(3.0); //0.0762;
  ...
  public static final class AutoConstants {
    public static final double kMaxSpeedMetersPerSecond = Units.feetToMeters(18.8);
